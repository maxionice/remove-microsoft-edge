...
The exit code is printed to the console. A non-zero code usually means Edge was
still running (close all windows and retry) or that another installer instance
was active. Reboot and run the tool again.
